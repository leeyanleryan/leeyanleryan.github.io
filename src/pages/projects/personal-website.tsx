  ...
  return (
    <>
      <div id="page-about-projects" className="w3-main">
        <section id="personal-website" className="w3-container">
          <h2><b>Personal Website</b></h2>
          <div className="media-display">
            <VideoLoader file="personal-website2" fileWidth={800} fileHeight={450} cssWidth="80%" />
          </div>
          ...
          <div className="media-display">
            <VideoLoader file="personal-website-lt1" fileWidth={800} fileHeight={450} cssWidth="50%" />
            <VideoLoader file="personal-website-lt2" fileWidth={800} fileHeight={450} cssWidth="50%" />
          </div>
          <h5 className="h5-text-gap">
