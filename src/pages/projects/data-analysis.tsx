      ...
      <div id="page-about-projects" className="w3-main">
        <section id="data-analysis" className="w3-container">
          ...
          <div className="media-display">
            <ImageLoader file="dataanalysis-bca-heatmap1.png" fileWidth={683} fileHeight={574} cssWidth="33%" />
            <ImageLoader file="dataanalysis-bca-heatmap2.png" fileWidth={647} fileHeight={551} cssWidth="33%" />
            <ImageLoader file="dataanalysis-bca-heatmap3.png" fileWidth={670} fileHeight={573} cssWidth="33%" />
          </div>
          <h5 className="h5-text-gap">
          ...
          <div className="media-display">
            <ImageLoader file="dataanalysis-bca-fe1.png" fileWidth={655} fileHeight={547} cssWidth="50%" />
            <ImageLoader file="dataanalysis-bca-fe2.png" fileWidth={671} fileHeight={547} cssWidth="50%" />
          </div>
          <h5 className="h5-text-gap">
          ...
          <div style={{display:"flex", justifyContent:"center", gap:"10px", alignItems:"center"}}>
            <ImageLoader file="dataanalysis-ege-waittime1.png" fileWidth={976} fileHeight={455} cssWidth="100%" />
          </div>
          <h5 className="h5-text-gap">
