              ...
              {% if line.lang == "jp" %}
                ...
                {% for expl in line.explanation %}
                  <li>
                    ...
                    <h6 class="w3-col s4 m4" style="margin:0;">{{ expl.english }}</h6>
                  </li>
                {% endfor %}
              {% endif %}
            </ul>
