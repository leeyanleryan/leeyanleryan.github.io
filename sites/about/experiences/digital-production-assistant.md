...
<div id="page-about-experiences" class="w3-main">
  <section id="digital-production-assistant" class="w3-container">
    ...
    <div style="display:flex; justify-content:center; gap:10px; align-items:center;">
      <img src="/assets/gif/dpa-intro1.gif" alt="DPA Intro 1" style="width:32%;">
      <img src="/assets/gif/dpa-intro2.gif" alt="DPA Intro 2" style="width:32%;">
      <img src="/assets/gif/dpa-intro3.gif" alt="DPA Intro 3" style="width:32%;">
    </div>
